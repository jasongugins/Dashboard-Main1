...
export const ShopifySettings: React.FC<ShopifySettingsProps> = ({ clientId, clientName }) => {
  ...
  const { form, state, isConnecting, isConnected, isSyncing, updateForm, testConnection, syncNow } = useShopify({ clientId });
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            ...
            <div className="flex items-end gap-2">
              <button
                ...
                className="flex-1 px-3 py-2 bg-brand-600 hover:bg-brand-700 disabled:bg-slate-300 disabled:cursor-not-allowed text-white text-sm font-medium rounded-lg transition-colors shadow-sm"
              >
